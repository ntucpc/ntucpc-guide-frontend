...
function ContributorCard({
    ...
    const photoUrl =
        `/${publicRoot}/contributors/photos/${contributor.code}.png`.replace(
            /\/+/g,
            "/"
        )
    return (
            ...
            <ContentBody maxWidth="6xl">
                ...
                <div className="max-w-3xl mx-auto text-center">
                    <p className="text-lg text-gray-600 leading-relaxed mb-8">
                        NTUCPC Guide
                        是由專業程式競賽選手編寫的講義，提供適合新手自學、由淺入深的程式競賽學習資源。
                    </p>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-indigo-50/50 border border-indigo-100 rounded-2xl p-8 text-center mb-12">
                        <p className="text-gray-700 leading-relaxed mb-6">
                            NTUCPC Guide
                            受到來自許多人與其他網站的啟發，特別感謝
                            <HyperRefBlank
                                href="https://usaco.guide/"
                                className="mx-1 text-indigo-600 font-bold hover:underline"
                            >
                                USACO Guide
                            </HyperRefBlank>{" "}
                            和
                    ...
                    <div className="mt-20 pt-12 border-t border-gray-100">
                        <div className="flex flex-col items-center gap-6">
                            <div className="px-4 py-2 rounded-lg bg-orange-50 border border-orange-100 text-orange-700 text-sm font-medium">
                                🛠️ You are in development mode! （Production
                                不會有這區塊）
                            </div>
