        ...
        <div className="pb-20">
            ...
            <div className="mb-12">
                <div className="flex flex-col md:flex-row md:items-center gap-6 mb-6">
                    {/* Chapter Icon */}
                    <div className={`flex-shrink-0 flex items-center justify-center w-24 h-24 rounded-3xl bg-gray-50 text-6xl text-${chapter.iconColor || 'indigo-500'} shadow-sm border border-gray-100`}>
